...
The lodestone has 6 charges for the following properties, which you can use while you are holding the stone. The stone regains `dice: 1d6|avg|noform` (`1d6`) expended charges daily at dawn.
...
As an action, you can expend 3 charges to cast [reverse gravity](/Admin/CLI/spells/reverse-gravity.md) from the stone (save DC 18).
