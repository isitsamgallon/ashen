...
If the sphere comes into contact with a planar portal, such as that created by the [gate](/Admin/CLI/spells/gate.md) spell, or an extradimensional space, such as that within a [portable hole](/Admin/CLI/items/portable-hole.md), the DM determines randomly what happens, using the following table.
