...
This pristine book smells faintly of a random scent you find pleasing. When found, the book contains the following spells: [antipathy/sympathy](/Admin/CLI/spells/antipathy-sympathy.md), [charm person](/Admin/CLI/spells/charm-person.md), [dominate person](/Admin/CLI/spells/dominate-person.md), [enthrall](/Admin/CLI/spells/enthrall.md), [hypnotic pattern](/Admin/CLI/spells/hypnotic-pattern.md), [modify memory](/Admin/CLI/spells/modify-memory.md), and [suggestion](/Admin/CLI/spells/suggestion.md). It functions as a spellbook for you.
