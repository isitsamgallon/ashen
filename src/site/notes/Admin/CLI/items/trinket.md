...
| 46 | A dead [sprite](/Admin/CLI/bestiary/fey/sprite.md) inside a clear glass bottle |
...
| 81 | A purple handkerchief embroidered with the name of a powerful [archmage](/Admin/CLI/bestiary/humanoid/archmage.md) |
...
| 95 | A [petrified](/3-Mechanics/CLI/rules/conditions.md#petrified) mouse |
