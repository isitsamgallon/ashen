---
{"dg-publish":true,"permalink":"/admin/cli/items/wave/","tags":["compendium/src/5e/dmg","item/attunement/required","item/property/martial","item/property/thrown","item/property/versatile","item/rarity/legendary","item/weapon/martial/melee"],"updated":"2025-01-11T15:32:21.515+00:00"}
---
...
The weapon also functions as a [trident of fish command](/Admin/CLI/items/trident-of-fish-command.md) and a [weapon of warning](/Admin/CLI/items/weapon-of-warning.md). It can confer the benefit of a [cap of water breathing](/Admin/CLI/items/cap-of-water-breathing.md) while you hold it, and you can use it as a [cube of force](/Admin/CLI/items/cube-of-force.md) by choosing the effect, instead of pressing cube sides to select it.
...
The weapon communicates telepathically with its wielder and can speak, read, and understand Aquan. It can also speak with aquatic animals as if using a [speak with animals](/Admin/CLI/spells/speak-with-animals.md) spell, using telepathy to involve its wielder in the conversation.
