...
In addition, the Ollamh harp can be used to cast [confusion](/Admin/CLI/spells/confusion.md), [control weather](/Admin/CLI/spells/control-weather.md), and [fire storm](/Admin/CLI/spells/fire-storm.md).
