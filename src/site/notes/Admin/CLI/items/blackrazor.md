...
Whenever you use it to reduce a creature to 0 hit points, the sword slays the creature and devours its soul, unless it is a construct or an undead. A creature whose soul has been devoured by Blackrazor can be restored to life only by a [wish](/Admin/CLI/spells/wish.md) spell.
...
Blackrazor can cast the [haste](/Admin/CLI/spells/haste.md) spell on you once per day. It decides when to cast the spell and maintains [concentration](/3-Mechanics/CLI/rules/conditions.md#concentration) on it so that you don't have to.
...
Despite its nihilism, Blackrazor feels a strange kinship to [Wave](/Admin/CLI/items/wave.md) and [Whelm](/Admin/CLI/items/whelm.md), two other weapons locked away under White Plume Mountain. It wants the three weapons to be united again and wielded together in combat, even though it violently disagrees with [Whelm](/Admin/CLI/items/whelm.md) and finds [Wave](/Admin/CLI/items/wave.md) tedious.
