...
Found in a small container, this powder resembles very fine sand. It appears to be [dust of disappearance](/Admin/CLI/items/dust-of-disappearance.md), and an [identify](/Admin/CLI/spells/identify.md) spell reveals it to be such. There is enough of it for one use.
