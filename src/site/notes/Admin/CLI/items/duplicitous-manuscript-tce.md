...
When found, the book contains the following spells: [hallucinatory terrain](/Admin/CLI/spells/hallucinatory-terrain.md), [major image](/Admin/CLI/spells/major-image.md), [mirror image](/Admin/CLI/spells/mirror-image.md), [mislead](/Admin/CLI/spells/mislead.md), [Nystul's magic aura](/Admin/CLI/spells/nystuls-magic-aura.md), [phantasmal force](/Admin/CLI/spells/phantasmal-force.md), and [silent image](/Admin/CLI/spells/silent-image.md). It functions as a spellbook for you.
