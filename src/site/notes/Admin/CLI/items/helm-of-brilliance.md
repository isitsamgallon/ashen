...
- You can use an action to cast one of the following spells (save DC 18), using one of the helm's gems of the specified type as a component: [daylight](/Admin/CLI/spells/daylight.md) (opal), [fireball](/Admin/CLI/spells/fireball.md) (fire opal), [prismatic spray](/Admin/CLI/spells/prismatic-spray.md) (diamond), or [wall of fire](/Admin/CLI/spells/wall-of-fire.md) (ruby). The gem is destroyed when the spell is cast and disappears from the helm.  
