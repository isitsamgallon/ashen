...
| d100 + Level | Result |
|--------------|--------|
| 01-10 | You are jailed for `dice: 1d4\|avg\|noform` (`1d4`) days at the end of the downtime period on charges of disorderly conduct and disturbing the peace. You can pay a fine of 10 gp to avoid jail time, or you can try to resist arrest. |
...
| 31-40 | You are caught up in a whirlwind romance. Roll a `dice: d20\|avg\|noform` (`d20`). On a 1–5, the romance ends badly. On a 6–10, the romance ends amicably. On an 11–20, the romance is ongoing. You determine the identity of the love interest, subject to your DM's approval. If the romance ends badly, you might gain a new flaw. If it ends well or is ongoing, your new love interest might represent a new bond. |
