...
If a corrupted creature doesn't leave the plane within `dice: 1d4 + 2|avg|noform` (`1d4 + 2`) days, its alignment changes to chaotic evil. Casting the [dispel evil and good](/3-Mechanics/CLI/spells/dispel-evil-and-good.md) spell on the creature restores its original alignment.
