...
You can use a bonus action to drain vigor from the soul and regain `dice: 2d8|avg|noform` (`2d8`) hit points.
...
A creature that can see the sensor (such as one using [see invisibility](/Admin/CLI/spells/see-invisibility.md) or [truesight](/3-Mechanics/CLI/rules/senses.md#truesight)) sees a translucent image of the tormented humanoid whose soul you caged.
