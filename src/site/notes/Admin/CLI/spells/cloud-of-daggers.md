...
You fill the air with spinning daggers in a cube 5 feet on each side, centered on a point you choose within range. A creature takes `dice: 4d4|avg|noform` (`4d4`) slashing damage when it enters the spell's area for the first time on a turn or starts its turn there.
