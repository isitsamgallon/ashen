...
The creature's mind becomes feverish. The creature has disadvantage on Intelligence checks and Intelligence saving throws, and the creature behaves as if under the effects of the [confusion](/Admin/CLI/spells/confusion.md) spell during combat.
...
**Classes**: [Cleric](/Admin/CLI/classes/cleric.md), [Druid (Circle of Spores)](/Admin/CLI/classes/druid-circle-of-spores-tce.md), [Druid](/Admin/CLI/classes/druid.md), [Paladin (Oathbreaker)](/Admin/CLI/classes/paladin-oathbreaker.md), [Sorcerer (Divine Soul)](/Admin/CLI/classes/sorcerer-divine-soul-xge.md)
