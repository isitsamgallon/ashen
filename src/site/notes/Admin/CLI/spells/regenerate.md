...
You touch a creature and stimulate its natural healing ability. The target regains `dice: 4d8 + 15|avg|noform` (`4d8 + 15`) hit points. For the duration of the spell, the target regains 1 hit point at the start of each of its turns (10 hit points each minute).
