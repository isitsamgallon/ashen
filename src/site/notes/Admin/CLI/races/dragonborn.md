...
When you use your breath weapon, each creature in the area of the exhalation must make a saving throw, the type of which is determined by your draconic ancestry. The DC for this saving throw equals 8 + your Constitution modifier + your proficiency bonus. A creature takes `dice: 2d6|avg|noform` (`2d6`) damage on a failed save, and half as much damage on a successful one. The damage increases to `dice: 3d6|avg|noform` (`3d6`) at 6th level, `dice: 4d6|avg|noform` (`4d6`) at 11th level, and `dice: 5d6|avg|noform` (`5d6`) at 16th level.
