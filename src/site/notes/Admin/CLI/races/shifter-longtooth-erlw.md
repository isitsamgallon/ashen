...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/races/ERLW/Shifter%20001.webp#right)  
...
You have proficiency in the [Intimidation](/3-Mechanics/CLI/rules/skills.md#Intimidation) skill.

### Shifting Feature

While shifted, you can use your elongated fangs to make an unarmed strike as a bonus action. If you hit with your fangs, you can deal piercing damage equal to `dice: 1d6|avg|noform` (`1d6`) + your Strength modifier, instead of the bludgeoning damage normal for an unarmed strike.
