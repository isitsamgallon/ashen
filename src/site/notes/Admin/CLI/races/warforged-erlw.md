...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/races/ERLW/Warforged.webp#right)  
...
- You have advantage on saving throws against being [poisoned](/3-Mechanics/CLI/rules/conditions.md#poisoned), and you have resistance to poison damage.  
...
When you take a long rest, you must spend at least six hours in an inactive, motionless state, rather than sleeping. In this state, you appear inert, but it doesn't render you [unconscious](/3-Mechanics/CLI/rules/conditions.md#unconscious), and you can see and hear as normal.
...
Although they were manufactured, warforged are living humanoids. Resting, healing magic, and the [Medicine](/3-Mechanics/CLI/rules/skills.md#Medicine) skill all provide the same benefits to warforged that they do to other humanoids.
...
![](https://raw.githubusercontent.com/5etools-mirror-2/5etools-img/main/races/ERLW/Warforged%20001.webp#center)