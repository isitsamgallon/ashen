...
- You know the [guidance](/Admin/CLI/spells/guidance.md) cantrip.  
- You have the [guiding bolt](/Admin/CLI/spells/guiding-bolt.md) spell prepared. It counts as a druid spell for you, and it doesn't count against the number of spells you can have prepared.  
- You can cast [guiding bolt](/Admin/CLI/spells/guiding-bolt.md) without expending a spell slot. You can do so a number of times equal to your proficiency bonus, and you regain all expended uses when you finish a long rest.  
...
A constellation of a wise dragon appears on you. When you make an Intelligence or a Wisdom check or a Constitution saving throw to maintain [concentration](/3-Mechanics/CLI/rules/conditions.md#concentration) on a spell, you can treat a roll of 9 or lower on the `dice: d20|avg|noform` (`d20`) as a 10.
