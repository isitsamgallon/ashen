...
- (a) [scale mail](/Admin/CLI/items/scale-mail.md) or (b) [leather armor](/Admin/CLI/items/leather-armor.md)  
- (a) two [shortswords](/Admin/CLI/items/shortsword.md) or (b) two simple melee weapons  
- (a) a [dungeoneer's pack](/Admin/CLI/items/dungeoneers-pack.md) or (b) an [explorer's pack](/Admin/CLI/items/explorers-pack.md)  
- A [longbow](/Admin/CLI/items/longbow.md) and a [quiver](/Admin/CLI/items/quiver.md) of [20 arrows](/Admin/CLI/items/arrows-20.md)  
...
Choose a type of favored enemy: aberrations, beasts, celestials, constructs, dragons, elementals, fey, fiends, giants, monstrosities, oozes, plants, or undead. Alternatively, you can select two races of humanoid (such as [gnolls](/Admin/CLI/bestiary/humanoid/gnoll.md) and [orcs](/Admin/CLI/bestiary/humanoid/orc.md)) as favored enemies.
...
When you hit a creature with an attack roll, you can call on your mystical bond with nature to mark the target as your favored enemy for 1 minute or until you lose your [concentration](/3-Mechanics/CLI/rules/conditions.md#concentration) (as if you were concentrating on a spell).
...
- [Archery](/Admin/CLI/optional-features/archery.md)  
- [Defense](/Admin/CLI/optional-features/defense.md)  
...
For example, if you know the 1st-level spell [animal friendship](/Admin/CLI/spells/animal-friendship.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [animal friendship](/Admin/CLI/spells/animal-friendship.md) using either slot.
...
You can use a [druidic focus](/Admin/CLI/items/druidic-focus.md) as a spellcasting focus for your ranger spells. A druidic focus might be a sprig of mistletoe or holly, a wand or rod made of yew or another special wood, a staff drawn whole from a living tree, or an object incorporating feathers, fur, bones, and teeth from sacred animals.
...
| Ranger Level | Spell |
|--------------|-------|
| 3rd | [speak with animals](/Admin/CLI/spells/speak-with-animals.md) |
| 5th | [beast sense](/Admin/CLI/spells/beast-sense.md) |
| 9th | [speak with plants](/Admin/CLI/spells/speak-with-plants.md) |
| 13th | [locate creature](/Admin/CLI/spells/locate-creature.md) |
| 17th | [commune with nature](/Admin/CLI/spells/commune-with-nature.md) |
^primal-awareness-spells
...
> ![Fighting Style, Ranger](/Admin/CLI/optional-features/list-fighting-style-ranger.md#Fighting%20Style,%20Ranger)
