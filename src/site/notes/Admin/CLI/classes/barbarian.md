---
{"dg-publish":true,"permalink":"/admin/cli/classes/barbarian/","tags":["class/barbarian","compendium/src/5e/phb"],"updated":"2025-01-11T15:32:13.627+00:00"}
---
...
- (a) a [greataxe](/Admin/CLI/items/greataxe.md) or (b) any martial melee weapon  
- (a) two [handaxes](/Admin/CLI/items/handaxe.md) or (b) any simple weapon  
- An [explorer's pack](/Admin/CLI/items/explorers-pack.md), and four [javelins](/Admin/CLI/items/javelin.md)  
...
*3rd-level barbarian [optional class features](/3-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*
...
*7th-level barbarian [optional class features](/3-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*
