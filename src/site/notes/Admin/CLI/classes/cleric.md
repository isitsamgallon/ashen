...
- (a) a [mace](/Admin/CLI/items/mace.md) or (b) a [warhammer](/Admin/CLI/items/warhammer.md) (if proficient)  
- (a) [scale mail](/Admin/CLI/items/scale-mail.md), (b) [leather armor](/Admin/CLI/items/leather-armor.md), or (c) [chain mail](/Admin/CLI/items/chain-mail.md) (if proficient)  
...
- A [shield](/Admin/CLI/items/shield.md) and a [holy symbol](/Admin/CLI/items/holy-symbol.md)  
...
You can use a [holy symbol](/Admin/CLI/items/holy-symbol.md) as a spellcasting focus for your cleric spells.
