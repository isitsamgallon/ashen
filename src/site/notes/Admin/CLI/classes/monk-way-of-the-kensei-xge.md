...
- **Agile Parry**  
    ...
    If you make an unarmed strike as part of the [Attack](/3-Mechanics/CLI/rules/actions.md#Attack) action on your turn and are holding a kensei weapon, you can use it to defend yourself if it is a melee weapon. You gain a +2 bonus to AC until the start of your next turn, while the weapon is in your hand and you aren't [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated).  

- **Kensei's Shot**  

    You can use a bonus action on your turn to make your ranged attacks with a kensei weapon more deadly. When you do so, any target you hit with a ranged attack using a kensei weapon takes an extra `dice: 1d4|avg|noform` (`1d4`) damage of the weapon's type. You retain this benefit until the end of the current turn.  

#### Way of the Brush
_Source: Xanathar's Guide to Everything_

You gain proficiency with your choice of [calligrapher's supplies](/Admin/CLI/items/calligraphers-supplies.md) or [painter's supplies](/Admin/CLI/items/painters-supplies.md).
