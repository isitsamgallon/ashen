...
> 
> | Level | Cantrips Known | Spells Known | Spell Slots | Slot Level | [Invocations Known](/Admin/CLI/optional-features/list-eldritch-invocation.md) |
> |-------|----------------|--------------|-------------|------------|-------------------------------------------------------------------------------|
> | 1st | 2 | 2 | 1 | 1st | ⏤ |
> | 2nd | 2 | 3 | 2 | 1st | 2 |
> | 3rd | 2 | 4 | 2 | 2nd | 2 |
...
- (a) a [scholar's pack](/Admin/CLI/items/scholars-pack.md) or (b) a [dungeoneer's pack](/Admin/CLI/items/dungeoneers-pack.md)  
- [Leather armor](/Admin/CLI/items/leather-armor.md), any simple weapon, and two [daggers](/Admin/CLI/items/dagger.md)  
...
For example, when you are 5th level, you have two 3rd-level spell slots. To cast the 1st-level spell [witch bolt](/Admin/CLI/spells/witch-bolt.md), you must spend one of those slots, and you cast it as a 3rd-level spell.
...
You can use an [arcane focus](/Admin/CLI/items/arcane-focus.md) as a spellcasting focus for your warlock spells.
...
At 2nd level, you gain two eldritch invocations of your choice. A list of the available options can be found on the [Optional Features](/Admin/CLI/optional-features/list-eldritch-invocation.md) page. When you gain certain warlock levels, you gain additional invocations of your choice, as shown in the Invocations Known column of the Warlock table.
...
*4th-level warlock [optional class features](/3-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*
...
> ![Eldritch Invocation](/Admin/CLI/optional-features/list-eldritch-invocation.md#Eldritch%20Invocation)
^list-eldritch-invocation

> [!example]- Pact Boon
> ![Pact Boon](/Admin/CLI/optional-features/list-pact-boon.md#Pact%20Boon)
^list-pact-boon