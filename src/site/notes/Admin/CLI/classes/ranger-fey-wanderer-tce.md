...
| Ranger Level | Spells |
|--------------|--------|
| 3rd | [charm person](/Admin/CLI/spells/charm-person.md) |
| 5th | [misty step](/Admin/CLI/spells/misty-step.md) |
| 9th | [dispel magic](/Admin/CLI/spells/dispel-magic.md) |
| 13th | [dimension door](/Admin/CLI/spells/dimension-door.md) |
| 17th | [mislead](/Admin/CLI/spells/mislead.md) |
^fey-wanderer-spells
...
The royal courts of the Feywild have blessed you with the assistance of fey beings: you know [summon fey](/Admin/CLI/spells/summon-fey-tce.md). It doesn't count against the number of ranger spells you know, and you can cast it without a material component. You can also cast it once without a spell slot, and you regain the ability to do so when you finish a long rest.
...
You can slip in and out of the Feywild to move in a blink of an eye: you can cast [misty step](/Admin/CLI/spells/misty-step.md) without expending a spell slot. You can do so a number of times equal to your Wisdom modifier (minimum of once), and you regain all expended uses when you finish a long rest.
