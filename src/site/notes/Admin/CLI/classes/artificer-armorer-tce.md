...
You gain proficiency with heavy armor. You also gain proficiency with [smith's tools](/Admin/CLI/items/smiths-tools.md). If you already have this tool proficiency, you gain proficiency with one other type of [artisan's tools](/Admin/CLI/items/artisans-tools.md) of your choice.
...
|-----------------|-------|
| 3rd | [magic missile](/Admin/CLI/spells/magic-missile.md), [thunderwave](/Admin/CLI/spells/thunderwave.md) |
| 5th | [mirror image](/Admin/CLI/spells/mirror-image.md), [shatter](/Admin/CLI/spells/shatter.md) |
| 9th | [hypnotic pattern](/Admin/CLI/spells/hypnotic-pattern.md), [lightning bolt](/Admin/CLI/spells/lightning-bolt.md) |
| 13th | [fire shield](/Admin/CLI/spells/fire-shield.md), [greater invisibility](/Admin/CLI/spells/greater-invisibility.md) |
| 17th | [passwall](/Admin/CLI/spells/passwall.md), [wall of force](/Admin/CLI/spells/wall-of-force.md) |
^armorer-spells
...
Your metallurgical pursuits have led to you making armor a conduit for your magic. As an action, you can turn a suit of armor you are wearing into Arcane Armor, provided you have [smith's tools](/Admin/CLI/items/smiths-tools.md) in hand.
...
You can change the armor's model whenever you finish a short or long rest, provided you have [smith's tools](/Admin/CLI/items/smiths-tools.md) in hand.
