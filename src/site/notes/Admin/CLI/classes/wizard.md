...
- (a) a [quarterstaff](/Admin/CLI/items/quarterstaff.md) or (b) a [dagger](/Admin/CLI/items/dagger.md)  
- (a) a [component pouch](/Admin/CLI/items/component-pouch.md) or (b) an [arcane focus](/Admin/CLI/items/arcane-focus.md)  
- (a) a [scholar's pack](/Admin/CLI/items/scholars-pack.md) or (b) an [explorer's pack](/Admin/CLI/items/explorers-pack.md)  
- A [spellbook](/Admin/CLI/items/spellbook.md)  
...
For example, if you're a 3rd-level wizard, you have four 1st-level and two 2nd-level spell slots. With an Intelligence of 16, your list of prepared spells can include six spells of 1st or 2nd level, in any combination, chosen from your spellbook. If you prepare the 1st-level spell [magic missile](/Admin/CLI/spells/magic-missile.md), you can cast it using a 1st-level or a 2nd-level slot. Casting the spell doesn't remove it from your list of prepared spells.
...
You can use an [arcane focus](/Admin/CLI/items/arcane-focus.md) as a spellcasting focus for your wizard spells.
...
*3rd-level wizard [optional class features](/3-Mechanics/CLI/rules/variant-rules/optional-class-features-tce.md)*
