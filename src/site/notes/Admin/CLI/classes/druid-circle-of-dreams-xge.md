...
When you finish a short rest, you can cast one of the following spells, without expending a spell slot or requiring material components: [dream](/Admin/CLI/spells/dream.md) (with you as the messenger), [scrying](/Admin/CLI/spells/scrying.md), or [teleportation circle](/Admin/CLI/spells/teleportation-circle.md).

This use of [teleportation circle](/Admin/CLI/spells/teleportation-circle.md) is special. Rather than opening a portal to a permanent [teleportation circle](/Admin/CLI/spells/teleportation-circle.md), it opens a portal to the last location where you finished a long rest on your current plane of existence. If you haven't taken a long rest on your current plane, the spell fails but isn't wasted.
