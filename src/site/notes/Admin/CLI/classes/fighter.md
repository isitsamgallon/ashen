...
- (a) [chain mail](/Admin/CLI/items/chain-mail.md) or (b) [leather armor](/Admin/CLI/items/leather-armor.md), [longbow](/Admin/CLI/items/longbow.md), and [20 arrows](/Admin/CLI/items/arrows-20.md)  
- (a) a martial weapon and a [shield](/Admin/CLI/items/shield.md) or (b) two martial weapons  
- (a) a [light crossbow](/Admin/CLI/items/light-crossbow.md) and [20 bolts](/Admin/CLI/items/crossbow-bolts-20.md) or (b) two [handaxes](/Admin/CLI/items/handaxe.md)  
...
- [Great Weapon Fighting](/Admin/CLI/optional-features/great-weapon-fighting.md)  
- [Protection](/Admin/CLI/optional-features/protection.md)  
...
- Replace a [fighting style](/Admin/CLI/optional-features/list-fighting-style-fighter.md) you know with another fighting style available to fighters.  
- If you know any [maneuvers](/Admin/CLI/optional-features/list-maneuver-battle-master.md) from the [Battle Master](/Admin/CLI/classes/fighter-battle-master.md) archetype, you can replace one maneuver you know with a different maneuver.  
...
> ![Fighting Style, Fighter](/Admin/CLI/optional-features/list-fighting-style-fighter.md#Fighting%20Style,%20Fighter)
