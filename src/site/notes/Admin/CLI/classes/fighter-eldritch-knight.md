...
For example, if you know the 1st-level spell [shield](/Admin/CLI/spells/shield.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [shield](/Admin/CLI/spells/shield.md) using either slot.
