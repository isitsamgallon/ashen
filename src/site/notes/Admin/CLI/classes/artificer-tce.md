---
{"dg-publish":true,"permalink":"/admin/cli/classes/artificer-tce/","tags":["class/artificer","compendium/src/5e/tce"],"updated":"2025-01-11T15:32:13.599+00:00"}
---
...
> 
> | Level | [Infusions Known](/Admin/CLI/optional-features/list-artificer-infusion-tce.md) | Infused Items | Cantrips Known | 1st | 2nd | 3rd | 4th | 5th |
> |-------|--------------------------------------------------------------------------------|---------------|----------------|-----|-----|-----|-----|-----|
> | 1st | ⏤ | ⏤ | 2 | 2 | ⏤ | ⏤ | ⏤ | ⏤ |
> | 2nd | 4 | 2 | 2 | 2 | ⏤ | ⏤ | ⏤ | ⏤ |
> | 3rd | 4 | 2 | 2 | 3 | ⏤ | ⏤ | ⏤ | ⏤ |
...
- **Weapons**: simple
- **Tools**: [thieves' tools](/Admin/CLI/items/thieves-tools.md), [tinker's tools](/Admin/CLI/items/tinkers-tools.md), one type of [artisan's tools](/Admin/CLI/items/artisans-tools.md) of your choice
- **Skills**: Choose 2 from *Arcana*, *History*, *Investigation*, *Medicine*, *Nature*, *Perception*, *Sleight of Hand*

You begin play with the following equipment, in addition to any equipment provided by your background.

- any two simple weapons of your choice  
- a [light crossbow](/Admin/CLI/items/light-crossbow.md) and [20 bolts](/Admin/CLI/items/crossbow-bolts-20.md)  
- (a) [studded leather armor](/Admin/CLI/items/studded-leather-armor.md) or (b) [scale mail](/Admin/CLI/items/scale-mail.md)  
- [thieves' tools](/Admin/CLI/items/thieves-tools.md) and a [dungeoneer's pack](/Admin/CLI/items/dungeoneers-pack.md)  
...
- **Armor**: light, medium, shield
- **Weapons**: none
- **Tools**: [thieves' tools](/Admin/CLI/items/thieves-tools.md), [tinker's tools](/Admin/CLI/items/tinkers-tools.md)
...
You've learned how to invest a spark of magic into mundane objects. To use this ability, you must have [thieves' tools](/Admin/CLI/items/thieves-tools.md) or [artisan's tools](/Admin/CLI/items/artisans-tools.md) in hand. You then touch a Tiny nonmagical object as an action and give it one of the following magical properties of your choice:
...
You produce your artificer spell effects through your tools. You must have a spellcasting focus—specifically [thieves' tools](/Admin/CLI/items/thieves-tools.md) or some kind of [artisan's tool](/Admin/CLI/items/artisans-tools.md)—in hand when you cast any spell with this Spellcasting feature (meaning the spell has an 'M' component when you cast it). You must be proficient with the tool to use it in this way. See "chapter 5", "Equipment," in the "Player's Handbook" for descriptions of these tools.

After you gain the Infuse Item feature at 2nd level, you can also use any item bearing one of your infusions as a spellcasting focus.

> [!note] The Magic of Artifice
> 
> As an artificer, you use tools when you cast your spells. When describing your spellcasting, think about how you're using a tool to perform the spell effect. If you cast [cure wounds](/Admin/CLI/spells/cure-wounds.md) using [alchemist's supplies](/Admin/CLI/items/alchemists-supplies.md), you could be quickly producing a salve. If you cast it using [tinker's tools](/Admin/CLI/items/tinkers-tools.md), you might have a miniature mechanical spider that binds wounds. When you cast [poison spray](/Admin/CLI/spells/poison-spray.md), you could fling foul chemicals or use a wand that spits venom. The effect of the spell is the same as for a spellcaster of any other class, but your method of spellcasting is special.
> 
> The same principle applies when you prepare your spells. As an artificer, you don't study a spellbook or pray to prepare your spells. Instead, you work with your tools and create the specialized items you'll use to produce your effects. If you replace [cure wounds](/Admin/CLI/spells/cure-wounds.md) with [heat metal](/Admin/CLI/spells/heat-metal.md), you might be altering the device you use to heal—perhaps modifying a tool so that it channels heat instead of healing energy.
> 
...
If an infusion ends on an item that contains other things, like a [bag of holding](/Admin/CLI/items/bag-of-holding.md), its contents harmlessly appear in and around its space.
...
You've learned how to produce exactly the tool you need: with [thieves' tools](/Admin/CLI/items/thieves-tools.md) or [artisan's tools](/Admin/CLI/items/artisans-tools.md) in hand, you can magically create one set of [artisan's tools](/Admin/CLI/items/artisans-tools.md) in an unoccupied space within 5 feet of you. This creation requires 1 hour of uninterrupted work, which can coincide with a short or long rest. Though the product of magic, the tools are nonmagical, and they vanish when you use this feature again.
...
> ![Artificer Infusion](/Admin/CLI/optional-features/list-artificer-infusion-tce.md#Artificer%20Infusion)
