...
- **Tools**: three [musical instruments](/Admin/CLI/items/musical-instrument.md) of your choice
...
- (a) a [rapier](/Admin/CLI/items/rapier.md), (b) a [longsword](/Admin/CLI/items/longsword.md), or (c) any simple weapon  
- (a) a [diplomat's pack](/Admin/CLI/items/diplomats-pack.md) or (b) an [entertainer's pack](/Admin/CLI/items/entertainers-pack.md)  
- (a) a [lute](/Admin/CLI/items/lute.md) or (b) any other musical instrument  
- [Leather armor](/Admin/CLI/items/leather-armor.md), and a [dagger](/Admin/CLI/items/dagger.md)  
...
- **Armor**: light
- **Weapons**: none
- **Tools**: one [musical instrument](/Admin/CLI/items/musical-instrument.md) of your choice
...
For example, if you know the 1st-level spell [cure wounds](/Admin/CLI/spells/cure-wounds.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [cure wounds](/Admin/CLI/spells/cure-wounds.md) using either slot.
...
You can use a [musical instrument](/Admin/CLI/items/musical-instrument.md) as a spellcasting focus for your bard spells.
