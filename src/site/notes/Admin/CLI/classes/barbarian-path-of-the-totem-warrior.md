...
Yours is a path that seeks attunement with the natural world, giving you a kinship with beasts. At 3rd level when you adopt this path, you gain the ability to cast the [beast sense](/Admin/CLI/spells/beast-sense.md) and [speak with animals](/Admin/CLI/spells/speak-with-animals.md) spells, but only as rituals, as described in "chapter 10".
...
At 10th level, you can cast the [commune with nature](/Admin/CLI/spells/commune-with-nature.md) spell, but only as a ritual. When you do so, a spiritual version of one of the animals you chose for Totem Spirit or Aspect of the Beast appears to you to convey the information you seek.
