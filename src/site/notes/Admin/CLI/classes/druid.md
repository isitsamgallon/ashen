...
- **Armor**: light, medium
- **Weapons**: [clubs](/Admin/CLI/items/club.md), [daggers](/Admin/CLI/items/dagger.md), [darts](/Admin/CLI/items/dart.md), [javelins](/Admin/CLI/items/javelin.md), [maces](/Admin/CLI/items/mace.md), [quarterstaffs](/Admin/CLI/items/quarterstaff.md), [scimitars](/Admin/CLI/items/scimitar.md), [sickles](/Admin/CLI/items/sickle.md), [slings](/Admin/CLI/items/sling.md), [spears](/Admin/CLI/items/spear.md)
- **Tools**: [Herbalism kit](/Admin/CLI/items/herbalism-kit.md)
- **Skills**: Choose 2 from *Animal Handling*, *Arcana*, *Insight*, *Medicine*, *Nature*, *Perception*, *Religion*, *Survival*

You begin play with the following equipment, in addition to any equipment provided by your background.

- (a) a wooden [shield](/Admin/CLI/items/shield.md) or (b) any simple weapon  
- (a) a [scimitar](/Admin/CLI/items/scimitar.md) or (b) any simple melee weapon  
- [Leather armor](/Admin/CLI/items/leather-armor.md), an [explorer's pack](/Admin/CLI/items/explorers-pack.md), and a [druidic focus](/Admin/CLI/items/druidic-focus.md)  
...
You can use a [druidic focus](/Admin/CLI/items/druidic-focus.md) as a spellcasting focus for your druid spells.
...
You gain the ability to summon a spirit that assumes an animal form: as an action, you can expend a use of your Wild Shape feature to cast the [find familiar](/Admin/CLI/spells/find-familiar.md) spell, without material components.
