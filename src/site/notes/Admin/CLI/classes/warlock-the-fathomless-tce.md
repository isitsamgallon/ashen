...
| Spell Level | Spells |
|-------------|--------|
| 1st | [create or destroy water](/Admin/CLI/spells/create-or-destroy-water.md), [thunderwave](/Admin/CLI/spells/thunderwave.md) |
| 2nd | [gust of wind](/Admin/CLI/spells/gust-of-wind.md), [silence](/Admin/CLI/spells/silence.md) |
| 3rd | [lightning bolt](/Admin/CLI/spells/lightning-bolt.md), [sleet storm](/Admin/CLI/spells/sleet-storm.md) |
| 4th | [control water](/Admin/CLI/spells/control-water.md), [summon elemental](/Admin/CLI/spells/summon-elemental-tce.md) (water only) |
| 5th | [Bigby's hand](/Admin/CLI/spells/bigbys-hand.md) (appears as a tentacle), [cone of cold](/Admin/CLI/spells/cone-of-cold.md) |
^fathomless-expanded-spells
...
You learn the spell [Evard's black tentacles](/Admin/CLI/spells/evards-black-tentacles.md). It counts as a warlock spell for you, but it doesn't count against the number of spells you know. You can also cast it once without a spell slot, and you regain the ability to do so when you finish a long rest.
