...
| Cleric Level | Spells |
|--------------|--------|
| 1st | [charm person](/Admin/CLI/spells/charm-person.md), [disguise self](/Admin/CLI/spells/disguise-self.md) |
| 3rd | [mirror image](/Admin/CLI/spells/mirror-image.md), [pass without trace](/Admin/CLI/spells/pass-without-trace.md) |
| 5th | [blink](/Admin/CLI/spells/blink.md), [dispel magic](/Admin/CLI/spells/dispel-magic.md) |
| 7th | [dimension door](/Admin/CLI/spells/dimension-door.md), [polymorph](/Admin/CLI/spells/polymorph.md) |
| 9th | [dominate person](/Admin/CLI/spells/dominate-person.md), [modify memory](/Admin/CLI/spells/modify-memory.md) |
^trickery-domain-spells
...
At 8th level, you gain the ability to infuse your weapon strikes with poison—a gift from your deity. Once on each of your turns when you hit a creature with a weapon attack, you can cause the attack to deal an extra `dice: 1d8|avg|noform` (`1d8`) poison damage to the target. When you reach 14th level, the extra damage increases to `dice: 2d8|avg|noform` (`2d8`).
