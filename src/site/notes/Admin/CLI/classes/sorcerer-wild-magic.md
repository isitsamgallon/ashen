...
If a Wild Magic effect is a spell, it's too wild to be affected by Metamagic. If it normally requires [concentration](/3-Mechanics/CLI/rules/conditions.md#concentration), it doesn't require [concentration](/3-Mechanics/CLI/rules/conditions.md#concentration) in this case; the spell lasts for its full duration.

![Wild Magic Surge](/Admin/CLI/tables/wild-magic-surge.md)

### Tides of Chaos (Level 1)

Starting at 1st level, you can manipulate the forces of chance and chaos to gain advantage on one attack roll, ability check, or saving throw. Once you do so, you must finish a long rest before you can use this feature again.

Any time before you regain the use of this feature, the DM can have you roll on the [Wild Magic Surge](/Admin/CLI/tables/wild-magic-surge.md) table immediately after you cast a sorcerer spell of 1st level or higher. You then regain the use of this feature.
...
At 14th level, you gain a modicum of control over the surges of your wild magic. Whenever you roll on the [Wild Magic Surge](/Admin/CLI/tables/wild-magic-surge.md) table, you can roll twice and use either number.
