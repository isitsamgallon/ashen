...
|---------------|--------|
| 3rd | [sanctuary](/Admin/CLI/spells/sanctuary.md), [sleep](/Admin/CLI/spells/sleep.md) |
| 5th | [calm emotions](/Admin/CLI/spells/calm-emotions.md), [hold person](/Admin/CLI/spells/hold-person.md) |
| 9th | [counterspell](/Admin/CLI/spells/counterspell.md), [hypnotic pattern](/Admin/CLI/spells/hypnotic-pattern.md) |
| 13th | [Otiluke's resilient sphere](/Admin/CLI/spells/otilukes-resilient-sphere.md), [stoneskin](/Admin/CLI/spells/stoneskin.md) |
| 17th | [hold monster](/Admin/CLI/spells/hold-monster.md), [wall of force](/Admin/CLI/spells/wall-of-force.md) |
^oath-of-redemption-spells
...
You can use your Channel Divinity to augment your presence with divine power. As a bonus action, you grant yourself a +5 bonus to Charisma ([Persuasion](/3-Mechanics/CLI/rules/skills.md#Persuasion)) checks for the next 10 minutes.
...
Starting at 15th level, a holy presence mends your wounds in battle. You regain hit points equal to `dice: 1d6|avg|noform` (`1d6`) + half your paladin level if you end your turn in combat with fewer than half of your hit points remaining and you aren't [incapacitated](/3-Mechanics/CLI/rules/conditions.md#incapacitated).
